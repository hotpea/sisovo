SisOvo::Application.routes.draw do
  devise_for :users

  root :to =>  'chicken#index'
  get 'galinha/adicao_partial' => 'chicken#_new_partial'
  get 'galinha/edicao_partial/:id' => 'chicken#_edit_partial'
  post 'galinha/adicionar' => 'chicken#create'
